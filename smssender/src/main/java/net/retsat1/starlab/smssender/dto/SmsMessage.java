...
public class SmsMessage {
    ...
    public static final String SENDER = "SENDER"; // TODO I don't know if we
                                                  // need keep sender filed,
                                                  // because it will be always
                                                  // this same phone
     ...
     * </ul>
     */
    public static final String MESSAGE_STATUS = "MESSAGE_STATUS"; // -2 not sent
                                                                  // yet
    public static final int STATUS_UNSENT = -2;
    public static final int STATUS_SENDING = -3;
    /**
     * List of state you can find in {@link SmsStatusDeliveredReceiver}
     * <ul>
     * <li>Activity.RESULT_OK = -1</li>
     * <li>SmsManager.RESULT_ERROR_GENERIC_FAILURE = 1</li>
     * </ul>
     */
    public static final String DELIVERY_STATUS = "DELIVERY_STATUS"; // send,
                                                                    // received,
                                                                    // supplied
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://" + SheduleSmsContentProvider.PROVIDER_NAME + "/sms");
    ...
    public String toString() {
        return "SmsMessage [sender=" + sender + ", receiver=" + number + ", message=" + message + ", data=" + dateOfSetup + "]";
    }
}
